...
\begin{macro}{aif2}{test then \op else}{arnesi}{}
  Just like IF-BIND but the var is always IT.
...
\begin{macro}{acond2}{\rest clauses}{arnesi}{}
...
\begin{macro}{until*}{test \body body}{arnesi}{}
...
\begin{macro}{list-match-case}{target \body clauses}{arnesi}{}
  
\end{macro}

\begin{macro}{let1}{var val \body body}{arnesi}{}
