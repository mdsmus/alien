...
\begin{function}{op}{\rest args}[cl-ext]
...
\label{sec:copying-objects}

\begin{generic}{copy}{object \key discard-slots use-object}[cl-ext]
  
\end{generic}

\begin{generic}{shallow-copy}{object \key discard-slots use-object}[cl-ext]
  
\end{generic}

\begin{generic}{deep-copy}{object \key discard-slots use-object}[cl-ext]
  
\end{generic}

\begin{generic}{uninitialized-copy}{object}[cl-ext]
  
\end{generic}

\begin{generic}{}{}[cl-ext]
...
html-entities
A library for encoding and decoding (HTML/SGML/XML) entities in Common
Lisp.
